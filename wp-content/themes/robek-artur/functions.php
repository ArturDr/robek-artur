<?php
/**
 * Robek Artur functions and definitions
 *
 ...
 */
function robek_artur_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on Robek Artur, use a find and replace
		* to change 'robek-artur' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'robek-artur', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'robek-artur' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'robek_artur_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'robek_artur_setup' );
 ...
 */
function robek_artur_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'robek_artur_content_width', 640 );
}
add_action( 'after_setup_theme', 'robek_artur_content_width', 0 );
 ...
 */
function robek_artur_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'robek-artur' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'robek-artur' ),
...
add_action( 'widgets_init', 'robek_artur_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'robek_artur_scripts' );
